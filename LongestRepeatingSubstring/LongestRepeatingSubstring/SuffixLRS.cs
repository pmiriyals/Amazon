    ...
    public class SuffixLRS
    {
        ...
        public string LargestRepeatedSubString(string s)
        {
            for (int i = s.Length; i > 0; i--)
            {
                ...
                //We need not build the entire Suffix tree for this
                if (LongestRepeatedStr.Length > 0)
                {
                    Console.WriteLine(LongestRepeatedStr);
                    return LongestRepeatedStr;
                }
            }   //at this point I have my suffix tree ready

            //If I reach here I did not find any repeating substring
            return "";
        }
